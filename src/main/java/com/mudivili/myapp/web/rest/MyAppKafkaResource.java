...
@RestController
@RequestMapping("/api/my-app-kafka")
public class MyAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyAppKafkaResource.class);
    ...
    public MyAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
